...
Prefeitura SP São Paulo: 2ª Via da Taxa de Elevadores segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_sp_sao_paulo_tx_elevador@mcp.ai](mailto:pref_sp_sao_paulo_tx_elevador@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
